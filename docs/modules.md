...
| `arc/borrow.hpp` | Static-lifetime loans, one-writer edit packs, and loan-pack alias checks with core-owner access gates. |
...
| `arc/hls.hpp` | HLS-shaped fixed-loop kernels and silicon-plan metadata. |
