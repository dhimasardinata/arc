...
Declare `arc_requires(main_requires core nav)` in the component that includes this header.
...
Source landmarks: `Quaternion`, `ImuSample`, `Eskf`, `State`, `Vec3`, `ErrorVec`, `Covariance`.
