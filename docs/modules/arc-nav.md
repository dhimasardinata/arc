...
ESKF and quaternion navigation helpers.
...
Declare the CMake feature with `arc_requires(main_requires core nav)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core nav)
...
```text
I (000) arc-doc: module=arc/nav
I (001) arc-doc: feature=nav example=dsp
