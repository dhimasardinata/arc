...
Caller-buffer ML-KEM-shaped polynomial/KEM surfaces.

## What It Owns

- Header: `arc/kyber.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `kyber`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core kyber)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core kyber)
...
```text
I (000) arc-doc: module=arc/kyber
I (001) arc-doc: feature=kyber example=store
