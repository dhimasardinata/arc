...
Capability buffers, cache ownership, DMA copy, descriptor chains, pipelines, and placement helpers.
...
Declare the CMake feature with `arc_requires(main_requires core memory)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/memory
I (001) arc-doc: feature=memory example=root
