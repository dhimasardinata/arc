...
Xtensa TRAX instruction trace memory control.
...
Declare `arc_requires(main_requires core trax)` in the component that includes this header.
...
arc_requires(main_requires core trax)
...
Source landmarks: `Trax`, `Bank`, `Unit`.
