...
WPA2/WPA3 Enterprise setup for the shared STA radio.
...
Declare the CMake feature with `arc_requires(main_requires core eap)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core eap)
...
```text
I (000) arc-doc: module=arc/eap
I (001) arc-doc: feature=eap example=udp
