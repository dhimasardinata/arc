...
Modular arithmetic surfaces for encrypted telemetry aggregation.

## What It Owns

- Header: `arc/paillier.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `paillier`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core paillier)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core paillier)
...
```text
I (000) arc-doc: module=arc/paillier
I (001) arc-doc: feature=paillier example=store
