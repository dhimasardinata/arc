...
URI, streams, fixed records, CRDTs, BFT votes, MQTT, WebSocket, CoAP, and small HTTP server helpers without owning Wi-Fi.
...
Source landmarks: `arc/bft.hpp`, `arc/coap.hpp`, `arc/crdt.hpp`, `arc/http_server.hpp`, `arc/mqtt.hpp`, `arc/netrpc.hpp`, `arc/stream.hpp`, `arc/uri.hpp`.
