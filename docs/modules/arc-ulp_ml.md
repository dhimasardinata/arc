...
Declare the CMake feature with `arc_requires(main_requires core ulp_ml)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/ulp_ml
I (001) arc-doc: feature=ulp_ml example=sleep
