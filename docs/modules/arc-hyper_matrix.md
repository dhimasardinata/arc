# `arc/hyper_matrix.hpp`

Fixed probability tensor fusion for swarm observations.

## What It Owns

- Header: `arc/hyper_matrix.hpp`
- Module group: DSP, Control, ML, And Vision
- CMake feature: `hyper_matrix`
- Closest example: `examples/esp32s3/dsp`

Declare the CMake feature with `arc_requires(main_requires core hyper_matrix)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core hyper_matrix)
...
```text
I (000) arc-doc: module=arc/hyper_matrix
I (001) arc-doc: feature=hyper_matrix example=dsp
