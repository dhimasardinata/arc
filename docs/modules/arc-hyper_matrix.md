...
Declare `arc_requires(main_requires core hyper_matrix)` in the component that includes this header.
...
Source landmarks: `Pose6`, `HyperObservation`, `HyperMatrixHeader`, `HyperMatrix`, `SpatialModality`.
