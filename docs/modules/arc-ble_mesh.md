...
BLE Mesh payload validation and policy hooks.

## What It Owns

- Header: `arc/ble_mesh.hpp`
- Module group: Network, Radio, And Wire Protocols
- CMake feature: `ble_mesh`
- Closest example: `examples/esp32s3/udp`

Declare the CMake feature with `arc_requires(main_requires core ble_mesh)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core ble_mesh)
...
```text
I (000) arc-doc: module=arc/ble_mesh
I (001) arc-doc: feature=ble_mesh example=udp
