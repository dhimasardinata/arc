...
Timing/power side-channel policy hooks.

## What It Owns

- Header: `arc/cloak.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `cloak`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core cloak)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core cloak)
...
```text
I (000) arc-doc: module=arc/cloak
I (001) arc-doc: feature=cloak example=store
