...
Secure/non-secure world assignment planning.
...
Declare the CMake feature with `arc_requires(main_requires core sandbox)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/tee
I (001) arc-doc: feature=sandbox example=store
