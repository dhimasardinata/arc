...
Spike-driven inference primitives.
...
Declare the CMake feature with `arc_requires(main_requires core snn)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core snn)
...
```text
I (000) arc-doc: module=arc/snn
I (001) arc-doc: feature=snn example=dsp
