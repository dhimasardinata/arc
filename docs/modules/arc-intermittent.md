...
Declare `arc_requires(main_requires core intermittent)` in the component that includes this header.
...
Source landmarks: `BrownoutPlan`, `ResumeFrame`, `IntermittentCheckpoint`, `Intermittent`, `Checkpoint`.
