# `arc/intermittent.hpp`

RTC no-init checkpoints for brownout/intermittent execution.

## What It Owns

- Header: `arc/intermittent.hpp`
- Module group: ULP And Low-Power Coprocessor
- CMake feature: `intermittent`
- Closest example: `examples/esp32s3/sleep`

Declare the CMake feature with `arc_requires(main_requires core intermittent)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core intermittent)
...
```text
I (000) arc-doc: module=arc/intermittent
I (001) arc-doc: feature=intermittent example=sleep
