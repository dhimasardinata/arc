...
Dual-output comparison and policy hooks for lockstep safety checks.
...
- Header: `arc/lockstep.hpp`
- Module group: Program Shape And Ownership
- CMake feature: `lockstep`
- Closest example: `.`

Declare `arc_requires(main_requires core lockstep)` in the component that includes this header.
...
arc_requires(main_requires core lockstep)
...
Source landmarks: `LockstepFault`, `Lockstep`, `Fault`.
