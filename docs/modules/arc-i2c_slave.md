...
- Header: `arc/i2c_slave.hpp`
- Module group: Buses, Displays, And Data Capture
- CMake feature: `i2c`
- Closest example: `examples/esp32s3/i2c`

Declare `arc_requires(main_requires core i2c)` in the component that includes this header.
...
Source landmarks: `I2cSlave`, `State`, `Handle`, `Callbacks`, `Request`, `Receive`, `Resource`.
