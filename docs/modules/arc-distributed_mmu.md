# `arc/distributed_mmu.hpp`

Remote span fault planning and deterministic cache-line fetch policy.

## What It Owns

- Header: `arc/distributed_mmu.hpp`
- Module group: Memory, DMA, And Placement
- CMake feature: `distributed_mmu`
- Closest example: `examples/esp32s3/copy`

Declare the CMake feature with `arc_requires(main_requires core distributed_mmu)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core distributed_mmu)
...
```text
I (000) arc-doc: module=arc/distributed_mmu
I (001) arc-doc: feature=distributed_mmu example=copy
