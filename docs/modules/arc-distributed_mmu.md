...
Declare `arc_requires(main_requires core distributed_mmu)` in the component that includes this header.
...
Source landmarks: `RemoteLineRequest`, `RemoteFault`, `RemoteResume`, `DistributedSpan`, `DistributedPager`.
