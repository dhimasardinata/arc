...
Aligned raw Wi-Fi write-frame planning.
...
Declare the CMake feature with `arc_requires(main_requires core rdma)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core rdma)
...
```text
I (000) arc-doc: module=arc/rdma
I (001) arc-doc: feature=rdma example=udp
