...
Async DMA memcpy, exact tickets, and coherent copy leases.
...
Declare the CMake feature with `arc_requires(main_requires core copy)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core copy)
...
```text
I (000) arc-doc: module=arc/copy
I (001) arc-doc: feature=copy example=copy
