...
Declare `arc_requires(main_requires core copy)` in the component that includes this header.
...
Source landmarks: `CopyTicket`, `Copy`, `LeaseBase`, `OwnedLeaseBase`, `State`, `CopyBackend`, `Ticket`, `StrictTicket`, `Lease`, `StrictLease`.
