...
mDNS host and service advertisement.
...
Declare the CMake feature with `arc_requires(main_requires core mdns)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core mdns)
...
```text
I (000) arc-doc: module=arc/mdns
I (001) arc-doc: feature=mdns example=udp
