...
Peer clock discipline over fixed timestamp samples.

## What It Owns

- Header: `arc/timesync.hpp`
- Module group: GPIO, Timing, And Power
- CMake feature: `time`
- Closest example: `examples/esp32s3/pwm`

Declare the CMake feature with `arc_requires(main_requires core time)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core time)
...
```text
I (000) arc-doc: module=arc/timesync
I (001) arc-doc: feature=time example=pwm
