...
eFuse, MAC, package, and secure-version reads.
...
Declare the CMake feature with `arc_requires(main_requires core fuse)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core fuse)
...
```text
I (000) arc-doc: module=arc/fuse
I (001) arc-doc: feature=fuse example=pwm
