# `arc/acoustic_slam.hpp`

FMCW chirp, TDoA, range, and acoustic swarm helpers.

## What It Owns

- Header: `arc/acoustic_slam.hpp`
- Module group: DSP, Control, ML, And Vision
- CMake feature: `acoustic_slam`
- Closest example: `examples/esp32s3/dsp`

Declare the CMake feature with `arc_requires(main_requires core acoustic_slam)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core acoustic_slam)
...
```text
I (000) arc-doc: module=arc/acoustic_slam
I (001) arc-doc: feature=acoustic_slam example=dsp
