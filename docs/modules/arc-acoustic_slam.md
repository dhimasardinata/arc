...
Declare `arc_requires(main_requires core acoustic_slam)` in the component that includes this header.
...
Source landmarks: `Position3`, `AcousticAnchor`, `ChirpConfig`, `TdoaEstimate`, `AcousticSlam`.
