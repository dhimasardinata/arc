...
Declare the CMake feature with `arc_requires(main_requires core otg)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core otg)
...
```text
I (000) arc-doc: module=arc/otg
I (001) arc-doc: feature=otg example=spi
