...
Bounded WASM AOT translation policy surface.

## What It Owns

- Header: `arc/wasm_aot.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `wasm_aot`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core wasm_aot)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core wasm_aot)
...
```text
I (000) arc-doc: module=arc/wasm_aot
I (001) arc-doc: feature=wasm_aot example=store
