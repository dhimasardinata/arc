...
Declare `arc_requires(main_requires core wasm_aot)` in the component that includes this header.
...
Source landmarks: `WasmAotConfig`, `WasmCursor`, `WasmSandbox`, `WasmAot`, `WasmOp`.
