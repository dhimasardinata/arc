...
SD/MMC FAT mount and raw sector access.
...
Declare the CMake feature with `arc_requires(main_requires core sd)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core sd)
...
```text
I (000) arc-doc: module=arc/sd
I (001) arc-doc: feature=sd example=store
