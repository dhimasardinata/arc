...
Declare the CMake feature with `arc_requires(main_requires core pwm)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core pwm)
...
```text
I (000) arc-doc: module=arc/pwm
I (001) arc-doc: feature=pwm example=pwm
