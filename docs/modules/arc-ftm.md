...
Wi-Fi FTM ranging and multilateration helpers.
...
Declare the CMake feature with `arc_requires(main_requires core ftm)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core ftm)
...
```text
I (000) arc-doc: module=arc/ftm
I (001) arc-doc: feature=ftm example=udp
