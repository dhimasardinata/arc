...
Declare `arc_requires(main_requires core ftm)` in the component that includes this header.
...
Source landmarks: `FtmPeer`, `FtmSessionConfig`, `FtmMeasurement`, `Ftm`, `EspWifiFtmPolicy`.
