...
Declare `arc_requires(main_requires core star_tracker)` in the component that includes this header.
...
Source landmarks: `StarPoint`, `StarTriangle`, `StarPose`, `StarTracker`.
