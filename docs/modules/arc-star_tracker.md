# `arc/star_tracker.hpp`

Star centroid and catalog matching helpers.

## What It Owns

- Header: `arc/star_tracker.hpp`
- Module group: DSP, Control, ML, And Vision
- CMake feature: `star_tracker`
- Closest example: `examples/esp32s3/dsp`

Declare the CMake feature with `arc_requires(main_requires core star_tracker)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core star_tracker)
...
```text
I (000) arc-doc: module=arc/star_tracker
I (001) arc-doc: feature=star_tracker example=dsp
