...
Policy facade for cache-locked hot code or data regions.

## What It Owns

- Header: `arc/cache_lock.hpp`
...
```text
I (000) arc-doc: module=arc/cache_lock
I (001) arc-doc: feature=memory example=copy
