...
Move-only mbedTLS big integers.
...
Declare the CMake feature with `arc_requires(main_requires core mpi)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core mpi)
...
```text
I (000) arc-doc: module=arc/mpi
I (001) arc-doc: feature=mpi example=store
