...
AES, SHA, HMAC, signatures, MPI, XTS, Kyber, Paillier, PUF, secure boot, and related security helpers.

## What It Owns

- Header: `arc/crypto.hpp`
- Module group: Profile Modules
- CMake feature: `crypto`
- Closest example: `.`

Declare the CMake feature with `arc_requires(main_requires core crypto)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core crypto)
...
```text
I (000) arc-doc: module=arc/crypto
I (001) arc-doc: feature=crypto example=root
