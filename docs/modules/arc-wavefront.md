...
Declare `arc_requires(main_requires core wavefront)` in the component that includes this header.
...
Source landmarks: `WavePoint3`, `Transducer`, `WavefrontConfig`, `WavefrontPlan`, `Wavefront`.
