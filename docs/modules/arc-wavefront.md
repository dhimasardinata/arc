...
Multichannel acoustic phase planning and synthesis.

## What It Owns

- Header: `arc/wavefront.hpp`
- Module group: DSP, Control, ML, And Vision
- CMake feature: `wavefront`
- Closest example: `examples/esp32s3/dsp`

Declare the CMake feature with `arc_requires(main_requires core wavefront)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core wavefront)
...
```text
I (000) arc-doc: module=arc/wavefront
I (001) arc-doc: feature=wavefront example=dsp
