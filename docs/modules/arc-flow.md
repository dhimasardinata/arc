...
Static source-lane-sink data path composition.
...
Declare the CMake feature with `arc_requires(main_requires core flow)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core flow)
...
```text
I (000) arc-doc: module=arc/flow
I (001) arc-doc: feature=flow example=root
