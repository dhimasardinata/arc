...
Declare the CMake feature with `arc_requires(main_requires core rtc)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/rtc_ring
I (001) arc-doc: feature=rtc example=probe
