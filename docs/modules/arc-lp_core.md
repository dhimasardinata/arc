...
ESP32-P4 LP-core entry tags, image metadata, and shared handoff lanes.
...
- Header: `arc/lp_core.hpp`
- Module group: ULP And Low-Power Coprocessor
- CMake feature: `lp_core`
- Closest example: `examples/esp32s3/sleep`

Declare `arc_requires(main_requires core lp_core)` in the component that includes this header.
...
arc_requires(main_requires core lp_core)
...
Source landmarks: `Image`, `Control`, `Word`, `Mailbox`, `Entry`.
