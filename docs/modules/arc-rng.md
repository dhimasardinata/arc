...
Hardware random bytes and values.
...
Declare the CMake feature with `arc_requires(main_requires core rng)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core rng)
...
```text
I (000) arc-doc: module=arc/rng
I (001) arc-doc: feature=rng example=pwm
