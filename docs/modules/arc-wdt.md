...
Task watchdog setup, users, and feeds.
...
Declare the CMake feature with `arc_requires(main_requires core wdt)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core wdt)
...
```text
I (000) arc-doc: module=arc/wdt
I (001) arc-doc: feature=wdt example=pwm
