...
Declare the CMake feature with `arc_requires(main_requires core hls)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core hls)
...
```text
I (000) arc-doc: module=arc/hls
I (001) arc-doc: feature=hls example=dsp
