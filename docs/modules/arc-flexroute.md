...
Declare `arc_requires(main_requires core flexroute)` in the component that includes this header.
...
Source landmarks: `Route`, `FaultSample`, `FlexRoutePlan`, `FlexRoute`, `RouteDir`.
