...
GPIO matrix routing and policy-based spare-route repair.

## What It Owns

- Header: `arc/flexroute.hpp`
- Module group: GPIO, Timing, And Power
- CMake feature: `flexroute`
- Closest example: `examples/esp32s3/pwm`

Declare the CMake feature with `arc_requires(main_requires core flexroute)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core flexroute)
...
```text
I (000) arc-doc: module=arc/flexroute
I (001) arc-doc: feature=flexroute example=pwm
