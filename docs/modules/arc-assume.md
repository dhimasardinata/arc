...
Optimizer and unreachable-code hints where a contract has already been checked.

## What It Owns

- Header: `arc/assume.hpp`
...
```text
I (000) arc-doc: module=arc/assume
I (001) arc-doc: feature=core example=root
