...
Emergency and cross-partition IPC policy surface.
...
Declare the CMake feature with `arc_requires(main_requires core ipc)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core ipc)
...
```text
I (000) arc-doc: module=arc/ipc
I (001) arc-doc: feature=ipc example=root
