...
Declare the CMake feature with `arc_requires(main_requires core space)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/space
I (001) arc-doc: feature=space example=space
