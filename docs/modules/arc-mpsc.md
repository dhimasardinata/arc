...
Many-producer/one-consumer fan-in with cache-line isolated or dense cells.
...
Source landmarks: `MpscImpl`, `Producer`, `Consumer`, `Endpoints`, `Cell`, `Backoff`, `Audit`, `Mpsc`, `DenseMpsc`, `Mux`.
