...
Certificate-bundle policy hooks.

## What It Owns

- Header: `arc/cert_bundle.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `cert_bundle`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core cert_bundle)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core cert_bundle)
...
```text
I (000) arc-doc: module=arc/cert_bundle
I (001) arc-doc: feature=cert_bundle example=store
