# `arc/crypto_selftest.hpp`

Caller-owned KAT-style crypto self-test workspaces.
...
- Header: `arc/crypto_selftest.hpp`
...
Source landmarks: `SelfTestReport`, `KyberSelfTest`, `BlackBoxSelfTest`, `SelfTest`.
