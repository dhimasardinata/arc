...
Fixed-buffer MCAP telemetry records.
...
Declare `arc_requires(main_requires core mcap)` in the component that includes this header.
...
arc_requires(main_requires core mcap)
...
Source landmarks: `Meta`, `Schema`, `Channel`, `Message`, `Footer`, `Writer`, `Op`.
