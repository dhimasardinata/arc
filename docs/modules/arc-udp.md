...
Declare the CMake feature with `arc_requires(main_requires core udp)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core udp)
...
```text
I (000) arc-doc: module=arc/udp
I (001) arc-doc: feature=udp example=udp
