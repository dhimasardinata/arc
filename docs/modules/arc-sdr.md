...
LCD_CAM pulse-stream preparation for SDR experiments.
...
Declare the CMake feature with `arc_requires(main_requires core sdr)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core sdr)
...
```text
I (000) arc-doc: module=arc/sdr
I (001) arc-doc: feature=sdr example=dsp
