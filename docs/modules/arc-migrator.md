...
- Header: `arc/migrator.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `migrator`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core migrator)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core migrator)
...
```text
I (000) arc-doc: module=arc/migrator
I (001) arc-doc: feature=migrator example=store
