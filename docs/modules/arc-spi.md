...
SPI master bus/device, transfer tickets, and coherent queue/finish.
...
Declare the CMake feature with `arc_requires(main_requires core spi)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core spi)
...
```text
I (000) arc-doc: module=arc/spi
I (001) arc-doc: feature=spi example=spi
