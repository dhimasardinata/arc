...
RGB LCD panel output and frame-buffer ownership.
...
- CMake feature: `lcd`
- Closest example: `examples/esp32s3/i80`
...
The closest shipped example is `examples/esp32s3/i80`.

```sh
. ./env.sh
idf.py -C examples/esp32s3/i80 build
idf.py -C examples/esp32s3/i80 -p /dev/ttyACM0 flash monitor
```
...
```text
I (000) arc-doc: module=arc/rgb
I (001) arc-doc: feature=lcd example=i80
