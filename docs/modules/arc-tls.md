...
Direct ESP-TLS client sessions.
...
Declare the CMake feature with `arc_requires(main_requires core tls)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core tls)
...
```text
I (000) arc-doc: module=arc/tls
I (001) arc-doc: feature=tls example=udp
