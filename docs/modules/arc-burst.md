...
- Header: `arc/burst.hpp`
- Module group: GPIO, Timing, And Power
- CMake feature: `rmt`
- Closest example: `examples/esp32s3/count`

Declare the CMake feature with `arc_requires(main_requires core rmt)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core rmt)
...
```text
I (000) arc-doc: module=arc/burst
I (001) arc-doc: feature=rmt example=count
