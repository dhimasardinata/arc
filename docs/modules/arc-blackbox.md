...
Sealed Merkle-linked flight-recorder payloads.

## What It Owns

- Header: `arc/blackbox.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `blackbox`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core blackbox)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core blackbox)
...
```text
I (000) arc-doc: module=arc/blackbox
I (001) arc-doc: feature=blackbox example=store
