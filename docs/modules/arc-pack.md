...
Fixed binary record schemas and struct codecs.
...
- CMake feature: `core`
- Closest example: `examples/portable/pack`
...
The closest shipped example is `examples/portable/pack`.

```sh
. ./env.sh
idf.py -C examples/portable/pack build
idf.py -C examples/portable/pack -p /dev/ttyACM0 flash monitor
```
...
```text
I (000) arc-doc: module=arc/pack
I (001) arc-doc: feature=core example=pack
