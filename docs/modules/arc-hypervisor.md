...
Declare `arc_requires(main_requires core hypervisor)` in the component that includes this header.
...
Source landmarks: `TrapFrame`, `TrapDecision`, `Partition`, `Hypervisor`, `TrapKind`, `TrapAction`.
