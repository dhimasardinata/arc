...
Restricted partition planning and trap decisions.

## What It Owns

- Header: `arc/hypervisor.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `hypervisor`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core hypervisor)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core hypervisor)
...
```text
I (000) arc-doc: module=arc/hypervisor
I (001) arc-doc: feature=hypervisor example=store
