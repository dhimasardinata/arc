...
Executable payload loading and IRAM detour policy hooks.

## What It Owns

- Header: `arc/hotpatch.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `hotpatch`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core hotpatch)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core hotpatch)
...
```text
I (000) arc-doc: module=arc/hotpatch
I (001) arc-doc: feature=hotpatch example=store
