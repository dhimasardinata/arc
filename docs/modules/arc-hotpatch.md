...
Declare `arc_requires(main_requires core hotpatch)` in the component that includes this header.
...
Source landmarks: `HotPatchBlock`, `HotPatchDetour`, `HotPatchHeapPolicy`, `HotPatchImage`, `HotPatch`.
