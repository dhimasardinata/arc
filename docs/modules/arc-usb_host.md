...
USB host bring-up, polling, and transfer policy hooks.

## What It Owns

- Header: `arc/usb_host.hpp`
- Module group: Buses, Displays, And Data Capture
- CMake feature: `usb_host`
- Closest example: `examples/esp32s3/spi`

Declare the CMake feature with `arc_requires(main_requires core usb_host)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core usb_host)
...
```text
I (000) arc-doc: module=arc/usb_host
I (001) arc-doc: feature=usb_host example=spi
