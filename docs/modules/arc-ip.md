...
IP readiness and address-family helpers.
...
Declare the CMake feature with `arc_requires(main_requires core net)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core net)
...
```text
I (000) arc-doc: module=arc/ip
I (001) arc-doc: feature=net example=udp
