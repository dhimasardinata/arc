...
Dedicated GPIO output.

## What It Owns

- Header: `arc/drive.hpp`
- Module group: GPIO, Timing, And Power
- CMake feature: `gpio`
- Closest example: `examples/esp32s3/pwm`

Declare the CMake feature with `arc_requires(main_requires core gpio)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core gpio)
...
```text
I (000) arc-doc: module=arc/drive
I (001) arc-doc: feature=gpio example=pwm
