...
Heapless URI parsing and percent encode/decode.
...
Declare the CMake feature with `arc_requires(main_requires core uri)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core uri)
...
```text
I (000) arc-doc: module=arc/uri
I (001) arc-doc: feature=uri example=udp
