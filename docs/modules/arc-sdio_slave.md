...
Declare `arc_requires(main_requires core sdio_slave)` in the component that includes this header.
...
Source landmarks: `SdioSlaveConfig`, `SdioSlaveTransfer`, `SdioSlaveLease`, `SdioSlave`.
