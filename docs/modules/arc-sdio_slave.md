...
SDIO slave coherent queue/finish semantics.

## What It Owns

- Header: `arc/sdio_slave.hpp`
- Module group: Buses, Displays, And Data Capture
- CMake feature: `sdio_slave`
- Closest example: `examples/esp32s3/spi`

Declare the CMake feature with `arc_requires(main_requires core sdio_slave)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core sdio_slave)
...
```text
I (000) arc-doc: module=arc/sdio_slave
I (001) arc-doc: feature=sdio_slave example=spi
