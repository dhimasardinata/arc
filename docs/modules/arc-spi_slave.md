...
Declare `arc_requires(main_requires core spi)` in the component that includes this header.
...
Source landmarks: `SpiSlave`, `TicketBase`, `Ticket`, `State`, `Transaction`, `Move`, `StrictMove`, `Resource`.
