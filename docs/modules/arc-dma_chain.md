...
Static DMA descriptor rings and owned DMA-chain buffers.

## What It Owns

- Header: `arc/dma_chain.hpp`
...
```text
I (000) arc-doc: module=arc/dma_chain
I (001) arc-doc: feature=core example=copy
