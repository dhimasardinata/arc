...
Kinematics and no-allocation G-code parsing.
...
Declare the CMake feature with `arc_requires(main_requires core cnc)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core cnc)
...
```text
I (000) arc-doc: module=arc/cnc
I (001) arc-doc: feature=cnc example=dsp
