...
Compile-time ULP RISC-V program assembly.

## What It Owns

- Header: `arc/ulp_asm.hpp`
- Module group: ULP And Low-Power Coprocessor
- CMake feature: `ulp`
- Closest example: `examples/esp32s3/sleep`

Declare the CMake feature with `arc_requires(main_requires core ulp)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core ulp)
...
```text
I (000) arc-doc: module=arc/ulp_asm
I (001) arc-doc: feature=ulp example=sleep
