...
Entropy sampling, extraction, and key derivation hooks.
...
Declare the CMake feature with `arc_requires(main_requires core puf)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core puf)
...
```text
I (000) arc-doc: module=arc/puf
I (001) arc-doc: feature=puf example=store
