...
AES block, stream modes, and GCM.
...
Declare the CMake feature with `arc_requires(main_requires core aes)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core aes)
...
```text
I (000) arc-doc: module=arc/aes
I (001) arc-doc: feature=aes example=store
