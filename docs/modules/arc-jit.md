...
Bounded BPF-to-executable-word translation hooks.
...
Declare the CMake feature with `arc_requires(main_requires core jit)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core jit)
...
```text
I (000) arc-doc: module=arc/jit
I (001) arc-doc: feature=jit example=store
