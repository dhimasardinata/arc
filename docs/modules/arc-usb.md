...
Declare the CMake feature with `arc_requires(main_requires core usb)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core usb)
...
```text
I (000) arc-doc: module=arc/usb
I (001) arc-doc: feature=usb example=uart
