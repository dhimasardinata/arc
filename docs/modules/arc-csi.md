...
Declare `arc_requires(main_requires core csi)` in the component that includes this header.
...
Source landmarks: `CsiConfig`, `CsiMeta`, `CsiBin`, `CsiFrame`, `CsiStats`, `CsiRawView`, `CsiRx`, `Csi`, `EspWifiCsiPolicy`, `CsiCallback`.
