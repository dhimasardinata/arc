...
Wi-Fi CSI capture and feature extraction.
...
Declare the CMake feature with `arc_requires(main_requires core csi)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core csi)
...
```text
I (000) arc-doc: module=arc/csi
I (001) arc-doc: feature=csi example=udp
