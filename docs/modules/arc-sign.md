...
Digital Signature peripheral operations.
...
Declare the CMake feature with `arc_requires(main_requires core sign)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core sign)
...
```text
I (000) arc-doc: module=arc/sign
I (001) arc-doc: feature=sign example=store
