...
PWM/Sigma-Delta FSK symbol planning for experimental air-gap channels.

## What It Owns

- Header: `arc/covert.hpp`
- Module group: DSP, Control, ML, And Vision
- CMake feature: `covert`
- Closest example: `examples/esp32s3/dsp`

Declare the CMake feature with `arc_requires(main_requires core covert)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core covert)
...
```text
I (000) arc-doc: module=arc/covert
I (001) arc-doc: feature=covert example=dsp
