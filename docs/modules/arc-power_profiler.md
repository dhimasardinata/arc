...
Declare the CMake feature with `arc_requires(main_requires core power_profiler)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/power_profiler
I (001) arc-doc: feature=power_profiler example=pwm
