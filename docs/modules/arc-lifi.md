...
Manchester optical symbol generation.
...
Declare the CMake feature with `arc_requires(main_requires core lifi)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core lifi)
...
```text
I (000) arc-doc: module=arc/lifi
I (001) arc-doc: feature=lifi example=dsp
