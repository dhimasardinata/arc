...
eFuse-keyed HMAC and temporary JTAG unlock.
...
Declare the CMake feature with `arc_requires(main_requires core hmac)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core hmac)
...
```text
I (000) arc-doc: module=arc/hmac
I (001) arc-doc: feature=hmac example=store
