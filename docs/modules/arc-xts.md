...
Encrypted flash read/write helpers.
...
Declare the CMake feature with `arc_requires(main_requires core xts)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core xts)
...
```text
I (000) arc-doc: module=arc/xts
I (001) arc-doc: feature=xts example=store
