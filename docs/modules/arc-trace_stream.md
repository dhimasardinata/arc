...
Declare the CMake feature with `arc_requires(main_requires core trace_live)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/trace_stream
I (001) arc-doc: feature=trace_live example=trace
