...
Declare `arc_requires(main_requires core power_governor)` in the component that includes this header.
...
Source landmarks: `GovernorConfig`, `GovernorDecision`, `Governor`, `GovernorAction`.
