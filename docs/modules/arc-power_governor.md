# `arc/power_governor.hpp`

Slack-based boost/release policy hooks.

## What It Owns

- Header: `arc/power_governor.hpp`
- Module group: GPIO, Timing, And Power
- CMake feature: `power_governor`
- Closest example: `examples/esp32s3/pwm`

Declare the CMake feature with `arc_requires(main_requires core power_governor)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core power_governor)
...
```text
I (000) arc-doc: module=arc/power_governor
I (001) arc-doc: feature=power_governor example=pwm
