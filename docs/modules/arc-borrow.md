...
Source landmarks: `BorrowMode`, `StaticRef`, `StaticLoan`, `StaticRead`, `StaticMut`, `StaticReads`, `StaticWrites`, `StaticEdit`, `LoanPack`, `HasLoan`, `HasStaticRead`, `HasStaticWrite`, `HasStaticRefRead`, `HasStaticRefWrite`, `StaticReadable`, `StaticWritable`, `LoanReadable`, `LoanWritable`, `set`, `with_read`, `with_reads`, `with_write`, `with_edit`.
