...
DSP, SIMD, fixed matrices, Kalman, motion, ML, and control math surfaces.
...
Declare the CMake feature with `arc_requires(main_requires core math)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core math)
...
```text
I (000) arc-doc: module=arc/math
I (001) arc-doc: feature=math example=root
