...
Declare `arc_requires(main_requires core math)` in the component that includes this header.
...
Source landmarks: `MotionStep`, `MotionSegment`, `MotionPlan`, `SCurvePoint`, `SCurve`.
