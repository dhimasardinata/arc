...
SPIFFS and FAT-on-flash VFS mounts.
...
Declare `arc_requires(main_requires core fs)` in the component that includes this header.
...
arc_requires(main_requires core fs)
