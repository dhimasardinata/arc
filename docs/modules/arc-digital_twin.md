...
- Header: `arc/digital_twin.hpp`
- Module group: DSP, Control, ML, And Vision
- CMake feature: `digital_twin`
- Closest example: `examples/esp32s3/dsp`

Declare the CMake feature with `arc_requires(main_requires core digital_twin)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core digital_twin)
...
```text
I (000) arc-doc: module=arc/digital_twin
I (001) arc-doc: feature=digital_twin example=dsp
