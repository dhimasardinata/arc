...
Declare the CMake feature with `arc_requires(main_requires core ota)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/ota
I (001) arc-doc: feature=ota example=ota
