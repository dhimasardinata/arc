...
CPU/APB/no-light-sleep PM locks.
...
Declare the CMake feature with `arc_requires(main_requires core pm)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core pm)
...
```text
I (000) arc-doc: module=arc/pm
I (001) arc-doc: feature=pm example=pwm
