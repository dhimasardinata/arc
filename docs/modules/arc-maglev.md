...
Unstable state-space control surfaces.

## What It Owns

- Header: `arc/maglev.hpp`
- Module group: DSP, Control, ML, And Vision
- CMake feature: `maglev`
- Closest example: `examples/esp32s3/dsp`

Declare the CMake feature with `arc_requires(main_requires core maglev)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core maglev)
...
```text
I (000) arc-doc: module=arc/maglev
I (001) arc-doc: feature=maglev example=dsp
