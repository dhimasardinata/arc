...
Small no-heap HTTP request parser, router, and response builder.

## What It Owns

- Header: `arc/http_server.hpp`
...
```text
I (000) arc-doc: module=arc/http_server
I (001) arc-doc: feature=core example=udp
