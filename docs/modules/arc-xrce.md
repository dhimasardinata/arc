...
Fixed-buffer DDS-XRCE message and submessage framing.
...
Declare `arc_requires(main_requires core xrce)` in the component that includes this header.
...
arc_requires(main_requires core xrce)
...
Source landmarks: `Key`, `Header`, `HeaderView`, `Submsg`, `SubView`, `Writer`, `Sub`.
