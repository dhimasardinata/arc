...
Sigma-Delta pulse-density output.

## What It Owns

- Header: `arc/sigma.hpp`
- Module group: GPIO, Timing, And Power
- CMake feature: `core`
- Closest example: `examples/esp32s3/sigma`
...
The closest shipped example is `examples/esp32s3/sigma`.

```sh
. ./env.sh
idf.py -C examples/esp32s3/sigma build
idf.py -C examples/esp32s3/sigma -p /dev/ttyACM0 flash monitor
```
...
```text
I (000) arc-doc: module=arc/sigma
I (001) arc-doc: feature=core example=sigma
