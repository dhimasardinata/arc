...
Bounded fault injection and postmortem logging.

## What It Owns

- Header: `arc/chaos.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `chaos`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core chaos)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core chaos)
...
```text
I (000) arc-doc: module=arc/chaos
I (001) arc-doc: feature=chaos example=store
