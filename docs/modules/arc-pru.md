...
PRU-style LCD_CAM/I2S descriptor output and parallel capture.
...
Declare the CMake feature with `arc_requires(main_requires core lcd)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/pru
I (001) arc-doc: feature=lcd example=spi
