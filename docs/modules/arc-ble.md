...
NimBLE lifecycle, GAP, advertising, and scanning bridge.
...
Declare the CMake feature with `arc_requires(main_requires core ble)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core ble)
...
```text
I (000) arc-doc: module=arc/ble
I (001) arc-doc: feature=ble example=udp
