...
Exact byte streams, length-prefixed frames, and small stream erasure.

## What It Owns

- Header: `arc/stream.hpp`
- Module group: Network, Radio, And Wire Protocols
- CMake feature: `net_codecs`
- Closest example: `examples/esp32s3/udp`

Declare the CMake feature with `arc_requires(main_requires core net_codecs)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/stream
I (001) arc-doc: feature=net_codecs example=udp
