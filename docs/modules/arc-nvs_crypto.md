...
Encrypted-NVS policy hooks.

## What It Owns

- Header: `arc/nvs_crypto.hpp`
- Module group: Crypto, Security, VM, And Sandbox
- CMake feature: `nvs_crypto`
- Closest example: `examples/esp32s3/store`

Declare the CMake feature with `arc_requires(main_requires core nvs_crypto)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core nvs_crypto)
...
```text
I (000) arc-doc: module=arc/nvs_crypto
I (001) arc-doc: feature=nvs_crypto example=store
