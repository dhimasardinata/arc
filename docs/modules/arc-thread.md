...
Declare the CMake feature with `arc_requires(main_requires core thread)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/thread
I (001) arc-doc: feature=thread example=udp
