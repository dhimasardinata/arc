...
Capacitive touch controller and channel ownership.

## What It Owns

- Header: `arc/touch.hpp`
- Module group: GPIO, Timing, And Power
- CMake feature: `touch`
- Closest example: `examples/esp32s3/pwm`

Declare the CMake feature with `arc_requires(main_requires core touch)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core touch)
...
```text
I (000) arc-doc: module=arc/touch
I (001) arc-doc: feature=touch example=pwm
