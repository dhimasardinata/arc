...
Distributed snapshots, schedules, and swarm helper types.

## What It Owns

- Header: `arc/swarm.hpp`
- Module group: Network, Radio, And Wire Protocols
- CMake feature: `fabric`
- Closest example: `examples/esp32s3/udp`

Declare the CMake feature with `arc_requires(main_requires core fabric)` when this header needs ESP-IDF components beyond the base Arc component.
...
arc_requires(main_requires core fabric)
...
```text
I (000) arc-doc: module=arc/swarm
I (001) arc-doc: feature=fabric example=udp
