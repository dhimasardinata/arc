...
Declare `arc_requires(main_requires core fabric)` in the component that includes this header.
...
Source landmarks: `SwarmSchedule`, `DistributedRcuFrame`, `DistributedRcu`, `RemoteSlot`, `DeadReckoning`, `Frame`.
