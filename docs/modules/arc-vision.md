...
Sobel, optical flow, visual servo, and related vision kernels.

## What It Owns

- Header: `arc/vision.hpp`
- Module group: DSP, Control, ML, And Vision
- CMake feature: `robotics`
- Closest example: `examples/esp32s3/dsp`

Declare the CMake feature with `arc_requires(main_requires core robotics)` when this header needs ESP-IDF components beyond the base Arc component.
...
```text
I (000) arc-doc: module=arc/vision
I (001) arc-doc: feature=robotics example=dsp
