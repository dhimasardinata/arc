...
| Static loan | A zero-storage `arc::StaticLoan` that proves the object has static storage and carries readonly or mutable access plus an optional core owner in the type. |
