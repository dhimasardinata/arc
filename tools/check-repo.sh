...
for file in env.sh tools/host-tests.sh tools/host-bench.sh tools/framework-compare.sh tools/ensure-frameworks.sh tools/sync-idf.sh tools/dump-source.py tools/arc-pack-bridge.py tools/clangd-compile-commands.py tools/format.sh tools/install-git-hooks.sh examples/*/env.sh; do
