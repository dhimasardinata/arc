...
SPECIAL_LANDMARKS = {
    ...
    "arc/roles.hpp": ["RoleEndpoint", "PushRole", "PopRole", "RpcClientRole", "RpcServerRole", "Roles"],
    "arc/task.hpp": ["CoreMap", "CoreLocal", "CoreMsg", "TaskMem", "Core", "CoreRole", "StaticObject"],
}
