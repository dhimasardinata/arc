...
- `components/arc/profiles.json` is the source-of-truth profile manifest, and `tools/profile-manifest-check.py` keeps it synchronized with `cmake/arc-deps.cmake`.
