...
5. Use `docs/modules.md` to choose the right Arc header.
6. Use `docs/module-pages.md` for a page dedicated to that header.
7. Use `docs/examples.md` to pick a working firmware project near that hardware lane.
8. Use `docs/api.md` for exact public methods, failure behavior, and ownership notes.
